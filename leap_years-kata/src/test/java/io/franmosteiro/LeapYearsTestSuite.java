...
public class LeapYearsTestSuite {
    ...
    @Test
    public void year_divisible_by_400_should_be_leap() throws Exception {
    ...
    @Test
    public void year_not_divisible_by_400_should_not_be_leap() throws Exception {
        LeapYears sut = new LeapYears();
    ...
    @Test
    public void year_divisible_by_4_and_not_by_100_should_be_leap() throws Exception {
        LeapYears sut = new LeapYears();
    ...
    @Test
    public void year_not_divisible_by_4_and_should_not_be_leap() throws Exception {
        LeapYears sut = new LeapYears();
